...
public class InternalBajaUSInterface
  implements IPrivateBajaUSInterface, com.sap.tc.webdynpro.progmodel.gci.IGCICustomControllerDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalBajaUSInterface.class);
   ...
   */
  private final com.quilmes.baja.BajaUSInterface delegate;
...

  {
    ...
    infoContext = GCIContext.createNode("Context", null, true, true, false, true, false, true, null,
      new IGCIAttributeInfo[] {
        GCIContext.createMappedAttribute("tipo_usuario", ".BajaUS.master", false),
        GCIContext.createMappedAttribute("nro_cliente", ".BajaUS.numero", false),
   ...
   */
  public InternalBajaUSInterface(com.sap.tc.webdynpro.progmodel.gci.IGCICustomController alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.quilmes.baja.BajaUSInterface((IPrivateBajaUSInterface) this);
  }
  ...
  public void complete( java.lang.String _status ) {
    delegate.complete( _status);
  }
  ...
  public void wdFireEventTechnicalException( com.sap.caf.eu.gp.exception.api.GPTechnicalCallableObjectException _technicalException ) {
    ...
    wdAlterEgo.getComponentGCI().fireEvent("BajaUSInterface", "TechnicalException", parameters);
  }
  ...
  private class External
    implements com.sap.tc.webdynpro.progmodel.api.IWDExternalControllerInterface, IExternalBajaUSInterface
  {
    ...
    public com.sap.caf.eu.gp.co.api.IGPTechnicalDescription getDescription( java.util.Locale _locale ) {
      return InternalBajaUSInterface.this.getDescription( _locale);
    }

    public void execute( com.sap.caf.eu.gp.co.api.IGPExecutionContext _executionContext ) {
      InternalBajaUSInterface.this.execute( _executionContext);
    }

    public void complete( java.lang.String _status ) {
      InternalBajaUSInterface.this.complete( _status);
    }
