...
public class InternalBajaUSInterfaceCfg
  implements IPrivateBajaUSInterfaceCfg, com.sap.tc.webdynpro.progmodel.gci.IGCICustomControllerDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalBajaUSInterfaceCfg.class);
   ...
   */
  private final com.quilmes.baja.BajaUSInterfaceCfg delegate;
   ...
   */
  public InternalBajaUSInterfaceCfg(com.sap.tc.webdynpro.progmodel.gci.IGCICustomController alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new com.quilmes.baja.BajaUSInterfaceCfg((IPrivateBajaUSInterfaceCfg) this);
  }
  ...
  private class External
    implements com.sap.tc.webdynpro.progmodel.api.IWDExternalControllerInterface, IExternalBajaUSInterfaceCfg
  {
