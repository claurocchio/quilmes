...
public class InternalPopWinInterfaceView
  implements IPrivatePopWinInterfaceView, com.sap.tc.webdynpro.progmodel.gci.IGCIViewDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalPopWinInterfaceView.class);
   ...
   */
  private final com.quilmes.baja.PopWinInterfaceView delegate;
   ...
   */
  public InternalPopWinInterfaceView(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    this.wdAlterEgo = alterEgo;
    this.delegate = new com.quilmes.baja.PopWinInterfaceView((IPrivatePopWinInterfaceView) this);
  }
