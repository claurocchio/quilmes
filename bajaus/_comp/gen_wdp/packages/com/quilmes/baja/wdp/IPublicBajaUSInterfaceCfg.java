...
public interface IPublicBajaUSInterfaceCfg extends com.quilmes.baja.wdp.IExternalBajaUSInterfaceCfg {
  ...
  {
    private InternalBajaUSInterfaceCfg gen_delegate;

    IContextNode(InternalBajaUSInterfaceCfg delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateBajaUSInterfaceCfg.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateBajaUSInterfaceCfg.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateBajaUSInterfaceCfg.IContextElement createContextElement() {
      return (IPrivateBajaUSInterfaceCfg.IContextElement)createElement();
    }
     ...
     */
    public void bind(IPrivateBajaUSInterfaceCfg.IContextElement element) {
     ...
     */
    public IPrivateBajaUSInterfaceCfg.IContextElement currentContextElement() {
      return (IPrivateBajaUSInterfaceCfg.IContextElement) getCurrentElement();
    }
  ...
  public static class IContextElement extends com.sap.tc.webdynpro.progmodel.context.NodeElement
  {
    ...
    public IContextElement(InternalBajaUSInterfaceCfg delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
