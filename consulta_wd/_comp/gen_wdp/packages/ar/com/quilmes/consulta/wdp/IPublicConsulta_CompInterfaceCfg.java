...
public interface IPublicConsulta_CompInterfaceCfg extends ar.com.quilmes.consulta.wdp.IExternalConsulta_CompInterfaceCfg {
  ...
  {
    private InternalConsulta_CompInterfaceCfg gen_delegate;

    IContextNode(InternalConsulta_CompInterfaceCfg delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateConsulta_CompInterfaceCfg.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateConsulta_CompInterfaceCfg.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateConsulta_CompInterfaceCfg.IContextElement createContextElement() {
      return (IPrivateConsulta_CompInterfaceCfg.IContextElement)createElement();
    }
     ...
     */
    public void bind(IPrivateConsulta_CompInterfaceCfg.IContextElement element) {
     ...
     */
    public IPrivateConsulta_CompInterfaceCfg.IContextElement currentContextElement() {
      return (IPrivateConsulta_CompInterfaceCfg.IContextElement) getCurrentElement();
    }
  ...
  public static class IContextElement extends com.sap.tc.webdynpro.progmodel.context.NodeElement
  {
    ...
    public IContextElement(InternalConsulta_CompInterfaceCfg delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
