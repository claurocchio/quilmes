...
public class InternalConsulta_WindowInterfaceView
  implements IPrivateConsulta_WindowInterfaceView, com.sap.tc.webdynpro.progmodel.gci.IGCIViewDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalConsulta_WindowInterfaceView.class);
   ...
   */
  private final ar.com.quilmes.consulta.Consulta_WindowInterfaceView delegate;
   ...
   */
  public InternalConsulta_WindowInterfaceView(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    this.wdAlterEgo = alterEgo;
    this.delegate = new ar.com.quilmes.consulta.Consulta_WindowInterfaceView((IPrivateConsulta_WindowInterfaceView) this);
  }
  ...
  /** outbound plug */
  public void wdFirePlugInternet( java.lang.String _Url ) {
    Map parameters = new HashMap();
    parameters.put("Url", _Url);
    wdAlterEgo.navigate("internet", parameters);
  }
