...
public class InternalWebDynproCOInterfaceView
  implements IPrivateWebDynproCOInterfaceView, com.sap.tc.webdynpro.progmodel.gci.IGCIViewDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalWebDynproCOInterfaceView.class);
   ...
   */
  private final ar.com.quilmes.consulta.WebDynproCOInterfaceView delegate;
   ...
   */
  public InternalWebDynproCOInterfaceView(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    this.wdAlterEgo = alterEgo;
    this.delegate = new ar.com.quilmes.consulta.WebDynproCOInterfaceView((IPrivateWebDynproCOInterfaceView) this);
  }
