...
public class InternalConsulta_Comp
  implements IPrivateConsulta_Comp, com.sap.tc.webdynpro.progmodel.gci.IGCIComponentDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalConsulta_Comp.class);
   ...
   */
  private final ar.com.quilmes.consulta.Consulta_Comp delegate;
...

  {
    ...
    infoClientes = GCIContext.createNode("Clientes", ar.com.quilmes.bue.mdm_clientes.model.externas.Cliente.class, true, false, true, false, false, true, null,
    ...
    infoContext = GCIContext.createNode("Context", null, true, true, false, true, false, true, null,
      new IGCIAttributeInfo[] {
        ...
        GCIContext.createAttribute("razon_social", "ddic:ar.com.quilmes.bue.mdm_clientes.types.simple.RazonSocial", null, null, false, false),
        GCIContext.createAttribute("nro_documento", "ddic:ar.com.quilmes.bue.mdm_clientes.types.simple.Documento", null, null, false, false),
      },
      new IGCINodeInfo[] {
        infoClientes,
        infoTipoDocumento,
   ...
   */
  public InternalConsulta_Comp(com.sap.tc.webdynpro.progmodel.gci.IGCIComponent alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new ar.com.quilmes.consulta.Consulta_Comp((IPrivateConsulta_Comp) this);
  }
