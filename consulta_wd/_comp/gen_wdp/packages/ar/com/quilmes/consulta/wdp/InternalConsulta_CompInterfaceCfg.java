...
public class InternalConsulta_CompInterfaceCfg
  implements IPrivateConsulta_CompInterfaceCfg, com.sap.tc.webdynpro.progmodel.gci.IGCICustomControllerDelegate
{

  /**
   * Location for this controller.
   */
  private static final Location logger = Location.getLocation(InternalConsulta_CompInterfaceCfg.class);
   ...
   */
  private final ar.com.quilmes.consulta.Consulta_CompInterfaceCfg delegate;
   ...
   */
  public InternalConsulta_CompInterfaceCfg(com.sap.tc.webdynpro.progmodel.gci.IGCICustomController alterEgo) {
    this.wdAlterEgo = alterEgo;
    wdInitContextNode();
    this.delegate = new ar.com.quilmes.consulta.Consulta_CompInterfaceCfg((IPrivateConsulta_CompInterfaceCfg) this);
  }
  ...
  private class External
    implements com.sap.tc.webdynpro.progmodel.api.IWDExternalControllerInterface, IExternalConsulta_CompInterfaceCfg
  {
